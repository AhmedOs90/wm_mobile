  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Manage Position Types</h2>
          <p className="text-gray-600">Wazifame - The Middle East Job Site Admin Panel</p>
        </div>
        <Button className="bg-gray-200 hover:bg-gray-300 text-gray-800">Add New Position Type</Button>
      </div>
      ...
      <Table>
        ...
        <TableBody>
          {positionTypesData.map((position, index) => (
            <TableRow key={index}>
              <TableCell>
                <Checkbox />
              </TableCell>
...
export default PositionTypesTab;
