...
type PointsDashboardProps = { employerId: string };

const PointsDashboard: React.FC<PointsDashboardProps> = ({ employerId }) => {
...
const styles = StyleSheet.create({
  ...
  rowWrapXs: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  ...
  redeemItem: { borderWidth: 1, borderRadius: 8, padding: 12, borderColor: '#e5e7eb' },
